...
class MiniMaxH3RolloutCollector:
    ...
    def _record_latent(self, video_target: torch.Tensor) -> None:
        ...
        if self.return_step_indices is not None and index not in self.return_step_indices:
            return
    ...
    def build_trajectory_data(self) -> RolloutTrajectoryData:
        ...
        return RolloutTrajectoryData(
            ...
            dit_trajectory=RolloutDitTrajectory(
                ...
                timesteps=timesteps,
                sigmas=sigmas,
                latent_step_indices=torch.tensor(self.latent_step_indices, dtype=torch.long),
            ),
        )
