...
from sglang.srt.multimodal.types import (  # noqa: F401
    MM_PAD_SHIFT_VALUE,
    Modality,
    MultimodalDataItem,
    MultimodalDataValue,
...
from sglang.srt.utils import flatten_nested_list  # noqa: F401
...
def sanity_check_mm_pad_shift_value(vocab_size: int) -> None:
    if vocab_size > MM_PAD_SHIFT_VALUE:
        raise ValueError(
            ...
            f"Please increase MM_PAD_SHIFT_VALUE in multimodal/types.py."
        )
